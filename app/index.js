...
module.exports = DrpxBase.extend({
	...
	files: function () {
		...
		this.template('src/_MainModule.js', 'src/'+this.mainModule+'/'+this.mainModule+'Module.js');
		this.template('src/_MainConfig.js', 'src/'+this.mainModule+'/'+this.mainModule+'Config.js');
	},
});